...
import { provider, isWindows } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/ofetch/dist/node.mjs';
import destr from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/scule/dist/index.mjs';
import { klona } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/projects/freelancing/nebula_nuxt/node_modules/radix3/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "API_BASE_URL": "https://tranquil-everglades-96249-a8ea8630be21.herokuapp.com/api/v1/adminpanel/"
  }
};
...
const serverAssets = [{"baseName":"server","dir":"D:/projects/freelancing/nebula_nuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\projects\\freelancing\\nebula_nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\projects\\freelancing\\nebula_nuxt\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\projects\\freelancing\\nebula_nuxt\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\projects\\freelancing\\nebula_nuxt\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\projects\\freelancing\\nebula_nuxt\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_4yXRm6 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_4yXRm6, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_4yXRm6, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/projects/freelancing/nebula_nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://D:/projects/freelancing/nebula_nuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"UTF-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<title>Nebula</title>\n<meta name=\"description\" content=\"Nebula admin project\">\n<meta property=\"og:image\" content=\"./favicon.ico\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":" lang=\"ru\"","bodyAttrs":""};
